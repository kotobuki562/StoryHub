...
const UploadSeasonImageFormComp: VFC<UpdateImageFormProps> = ({ userId }) => {
      ...
      async blob => {
        if (blob) {
          ...
          return await supabase.storage
            .from("management")
            .upload(`${userId}/season/${img?.name}`, blob, {
              cacheControl: "3600",
              upsert: true,
            })
            .then(async () => {
...
export const UploadSeasonImageForm = memo(UploadSeasonImageFormComp)
