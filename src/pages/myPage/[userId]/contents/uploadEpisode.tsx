...
const UploadEpisodeImageFormComp: VFC<UpdateImageFormProps> = ({ userId }) => {
      ...
      async blob => {
        if (blob) {
          ...
          return await supabase.storage
            .from("management")
            .upload(`${userId}/episode/${img?.name}`, blob, {
              cacheControl: "3600",
              upsert: true,
            })
            .then(async () => {
...
export const UploadEpisodeImageForm = memo(UploadEpisodeImageFormComp)
